...
const translations = {
  ID: {
    ...
    uploadCharacter: "Upload Gambar Karakter",
    ...
    promptTitle: "Deskripsi Video / Prompt",
    promptPlaceholder:
      'Contoh: "Seorang samurai berjalan di hutan bambu dengan cahaya matahari yang menyinari dedaunan"',
  ...
  EN: {
    ...
    promptTitle: "Video Description / Prompt",
    promptPlaceholder:
      'Example: "A samurai walking through a bamboo forest with sunlight filtering through the leaves"',
  ...
  AR: {
    ...
    uploadCharacter: "تحميل صورة الشخصية",
    ...
    promptTitle: "وصف الفيديو / المطالبة",
    promptPlaceholder:
      'مثال: "ساموراي يسير في غابة من الخيزران مع ضوء الشمس يتسلل عبر الأوراق"',
