...
import { Moon, Sun, Menu, Settings, CreditCard, Sparkles, Download, CheckCircle2 } from 'lucide-react';
  ...
  return /* @__PURE__ */ jsx("nav", { className: "sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-8", children: /* @__PURE__ */ jsxs("div", { className: "py-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ jsx("div", { className: "flex items-center", children: /* @__PURE__ */ jsx(
        Badge,
        {
          className: "px-6 py-3 text-base font-bold bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white border-0 shadow-lg",
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-4", children: [
        ...
        /* @__PURE__ */ jsx(Button, { variant: "ghost", size: "icon", className: "w-10 h-10 lg:hidden", children: /* @__PURE__ */ jsx(Menu, { className: "h-5 w-5" }) })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "flex justify-center px-8", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between w-full max-w-2xl relative", children: [
      ...
      steps.map((step, index) => {
        ...
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center relative z-10 min-w-0", children: [
          /* @__PURE__ */ jsx("div", { className: `
                    ...
                    `, children: step.completed ? /* @__PURE__ */ jsx(CheckCircle2, { className: "w-5 h-5" }) : /* @__PURE__ */ jsx(Icon, { className: `w-5 h-5 ${step.active ? "animate-pulse" : ""}` }) }),
